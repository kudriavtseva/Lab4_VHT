...
function enableButtons () {
	...
	btn = document.getElementById("input_greet_by_day");
	btn.onclick=function(){greetByDay();};
	
	btn.value="Click me for a personal greeting (with day)";
...
function greetByDay(){
	...
	var request = gapi.client.helloworldendpoints.greetByDay({'name': name, 'day':day});
	request.execute(sayHelloCallback);
}
