...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="greetByDay", path = "greetByDay", httpMethod = HttpMethod.GET)
    public HelloClass greetByDay(@Named("name") String name,    @Named("day") String day){
    	return new HelloClass(name,day);
    }
